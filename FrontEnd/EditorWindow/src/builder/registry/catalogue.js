...
export const catalogueMetadata = {
  // Sections
  blank: { category: "Sections", icon: Square, description: "Empty section to fill with your own content.", tags: ["new", "empty", "custom", "generic", "blank", "section"] },
  ...
  // Elements (Other)
  list: { category: "Typography", icon: List, description: "Bulleted or numbered list of points.", tags: ["bullet", "bullets", "points", "bulletpoints", "ul", "ol", "items", "steps"] },
